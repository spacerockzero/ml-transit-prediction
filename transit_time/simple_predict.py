...
if __name__ == "__main__":
    # Test examples
    print("=== Transit Time Prediction Examples ===\n")
    
    # Example 1: Domestic express
    pred1 = predict_transit_time('2024-01-15', 'US_WEST', 'US_EAST', 'FedEx', 'EXPRESS')
    print(f"US West -> US East, FedEx Express: {pred1} days")
    
    # Example 2: International standard
    pred2 = predict_transit_time('2024-01-15', 'US_WEST', 'ASIA_EAST', 'DHL', 'STANDARD') 
    print(f"US West -> Asia East, DHL Standard: {pred2} days")
    
    # Example 3: Regional overnight
    pred3 = predict_transit_time('2024-01-15', 'EU_WEST', 'EU_EAST', 'UPS', 'OVERNIGHT')
    print(f"EU West -> EU East, UPS Overnight: {pred3} days")
    
    # Example 4: Weekend effect
    pred4 = predict_transit_time('2024-01-13', 'US_WEST', 'US_EAST', 'FedEx', 'EXPRESS')  # Saturday
    print(f"US West -> US East, FedEx Express (Saturday): {pred4} days")

    # Example 5: Holiday season
    pred5 = predict_transit_time('2024-12-15', 'US_WEST', 'US_EAST', 'FedEx', 'EXPRESS')
    print(f"US West -> US East, FedEx Express (Holiday): {pred5} days")

    # example 6: future date
    pred6 = predict_transit_time('2025-06-01', 'US_WEST', 'EU_WEST', 'DHL', 'PRIORITY')
    print(f"US West -> EU West, DHL Priority (Future): {pred6} days")
    
    print("\n=== Interactive Prediction ===")
    print("You can use this function in your code like:")
    print("prediction = predict_transit_time('2024-01-15', 'US_WEST', 'US_EAST', 'FedEx', 'EXPRESS')")